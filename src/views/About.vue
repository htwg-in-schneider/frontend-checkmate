<template>
  <div class="container py-5">
    ...
    <p>
      ...
      Wir bringen Studierende, Tutor:innen und Lernbegeisterte zusammen, die sich gegenseitig
      unterstützen, motivieren und weiterbringen.
    </p>
    ...
    <p class="mt-4">
      Schön, dass du da bist – <strong>let’s learn together!</strong> 🧠💚
    </p>
  </div>
</template>